...
OWNER_NAME = getenv("OWNER_NAME", "GangsterOfficialTelegram")
ALIVE_NAME = getenv("ALIVE_NAME", "GangsterOfficialTelegram")
BOT_USERNAME = getenv("BOT_USERNAME", "Vcmusicbotbot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "GangMusicVc")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "gangsterofficialbots")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "gangsterbotschannel")
